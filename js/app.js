	...
	gameOver() {
		...
		if (this.isSolo) {
			...
			if (localStorage.getItem("player1lives") === "0" && !this.player1IsDead) {
				...
				// game end message
			} else if (localStorage.getItem("player2lives") === "0" && !this.player2IsDead) {
...
initClones(amountClones);
$("#enemies-left").text("Clones: " + amountClones);
